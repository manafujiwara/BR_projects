...
% Edit Mana Fujiwara 7-Jan-2013
% line 97, Inseted ['interpret','none']
...
ht=text(.5,titleypos-1,str,'interpret','none');set(ht,'horizontalalignment','center','fontsize',fs);
set(gcf,'nextplot',np);
axes(haold); %#ok<MAXES>
if nargout,
    hout=ht;

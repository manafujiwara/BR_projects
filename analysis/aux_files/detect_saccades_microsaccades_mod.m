function [saccade blink] = detect_saccades_microsaccades_mod (eall, whicheye, whicheyeanalyze, subjid, PARAMS, DIR)
...
try
    ...
    if isempty(index_nan)
        ...
        if isempty(blink_end) && max(index_nan)==1800000, blink_end = max(index_nan); end % Added by Mana. In case 
